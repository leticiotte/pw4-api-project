...
export const create = async (req: Request<{}, {}, Subject>, res: Response, next: NextFunction) => {
    ...
    const createdSubject: Subject = subjectRepository.create(subject);

    return res.status(StatusCodes.OK).json(createdSubject);
};
